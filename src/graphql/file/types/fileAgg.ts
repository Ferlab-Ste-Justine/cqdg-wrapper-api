...
const FileAgg = new GraphQLObjectType({
  ...
  fields: {
    ...
    sequencing_experiment__profiling_resolution: { type: AggregationsType },
    ...
    sequencing_experiment__experimental_strategy_1__display: { type: AggregationsType },
    sequencing_experiment__experimental_strategy_1__code: { type: AggregationsType },
